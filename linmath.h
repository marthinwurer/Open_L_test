...
typedef vec4 mat4x4[4]; // This is column major!
/*
 * M is ususally the output for these functions
 */
...
/*
 * Q is the output of M being rotated by angle radians around the y axis.
 */
 ...
 * y_fov is the field of view in the y dimension in radians
 * aspect is the aspect ratio (Width/Height)
 * n is near face distance from origin
 * f is far face distance from origin
 */
